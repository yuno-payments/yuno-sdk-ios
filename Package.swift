...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/30.30.30/YunoSDK_SPM.xcframework.zip",
            checksum: "38b15266ca774779933d9375c2913494af5f382533eb17413b1d8e88e2bbb7be"
        ),
        .binaryTarget(
            name: "OpenpayKit",
