...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/1.1.25/YunoSDK_SPM.xcframework.zip",
            checksum: "2d32e6bec6e01d2b03e4cca091885a1c943f913a3db14a3b302e5a52f9981780"
        ),
        .binaryTarget(
            name: "OpenpayKit",
