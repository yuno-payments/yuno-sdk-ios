...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/1.1.27/YunoSDK_SPM.xcframework.zip",
            checksum: "07d02502b160114f8da56eafeedf173eb4ca78e9415e62cf65574b4724a2ab44"
        ),
        .binaryTarget(
            name: "OpenpayKit",
