...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/1.1.18/YunoSDK_SPM.xcframework.zip",
            checksum: "8c324c97a72c7253d7222f4ecd213a85179948fda7f9a18af4020862ad80dd45"
        ),
        .binaryTarget(
            name: "OpenpayKit",
