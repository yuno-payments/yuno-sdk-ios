...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/2.17.0-RC/YunoSDK_SPM.xcframework.zip",
            checksum: "84272006ff5c70ee70c4b785344299f5a39fa81acad63fc6f7b6dd8324b6814c"
        ),
        .binaryTarget(
            name: "Yuno3DSNetcetera",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/2.17.0-RC/Yuno3DSNetcetera.xcframework.zip",
            checksum: "3b18d896e4e5a3e140570a0c0fa164e62575d32e9dae55d0edaafd8e4604203f"
        ),
        .binaryTarget(
            name: "ThreeDS_SDK",
