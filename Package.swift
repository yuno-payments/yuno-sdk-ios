...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/50.50.50/YunoSDK_SPM.xcframework.zip",
            checksum: "870d9dd902364e7e43dd20e9dbf38bf7f293c1773521592615bce511d0041f9a"
        ),
        .binaryTarget(
            name: "OpenpayKit",
