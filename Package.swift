...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/1.1.29/YunoSDK_SPM.xcframework.zip",
            checksum: "2f301f9593b392a53961b6b110080184b0f314d127bdbec3edd08920f7d0a4d8"
        ),
        .binaryTarget(
            name: "OpenpayKit",
