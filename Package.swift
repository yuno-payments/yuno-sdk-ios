...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/1.2.23/YunoSDK_SPM.xcframework.zip",
            checksum: "98ea4e15cd328299042d7cdc0eb96310a5edf2dd8b80b2d0973ab7c33410e561"
        ),
        .binaryTarget(
            name: "OpenpayKit",
