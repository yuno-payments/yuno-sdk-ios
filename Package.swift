...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YunoSDK",
            url: "https://github.com/yuno-payments/yuno-sdk-ios/releases/download/1.1.34-HR/YunoSDK_SPM.xcframework.zip",
            checksum: "a9119e3df2779e4993fdcc856dcc57d609cbf8d40cdce58f63d387437e2992dc"
        ),
        .binaryTarget(
            name: "OpenpayKit",
